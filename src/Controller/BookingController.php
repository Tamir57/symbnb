...
class BookingController extends AbstractController
{
    ...
    public function book(Ad $ad, Request $request, EntityManagerInterface $manager )
    {
        ...
        /* Le paramétrage des validations peut ce faire directement dans le formType     
    ...
    /**
     * Pertmet d'afficher la page d'une réservation et d'enregistrer le formualire de commentaire
