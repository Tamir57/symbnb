...
class User implements UserInterface
{
     ...
     *
     * @Assert\EqualTo(propertyPath="hash", message="vous n'avez correctement confirmer votre mot de passe")
     */
    ...
    // utiliser dans twig pour ne pas avoir a taper {{ a.firstname }} {{ a.lastname }} maus user.fullname
